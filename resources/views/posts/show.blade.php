            ...
            <div class="p-3 flex items-center">
                ...
                <form action="">
                    <div class="my-4">
                        ...
                        <button type="button" class="text-red-600 cursor-pointer p-1 hover:scale-125 transition ease-out duration-300">
                ...
                <p class="text-gray-700 font-bold text-sm p-1">0 likes</p>
            </div>
